	nios_system u0 (
		...
		.data_from_sof_export   (<connected-to-data_from_sof_export>),   //   data_from_sof.export
		.hardware_sig_export    (<connected-to-hardware_sig_export>),    //    hardware_sig.export
		...
		.reg_from_sof_export    (<connected-to-reg_from_sof_export>),    //    reg_from_sof.export
		...
		.software_sig_export    (<connected-to-software_sig_export>)     //    software_sig.export
	);
