...
module nios_system_mm_interconnect_0 (
		...
		output wire [1:0]  hardware_s1_address,                            //                              hardware_s1.address
		output wire        hardware_s1_write,                              //                                         .write
		input  wire [31:0] hardware_s1_readdata,                           //                                         .readdata
		output wire [31:0] hardware_s1_writedata,                          //                                         .writedata
		output wire        hardware_s1_chipselect,                         //                                         .chipselect
		...
		output wire [1:0]  software_s1_address,                            //                              software_s1.address
		input  wire [31:0] software_s1_readdata,                           //                                         .readdata
	...
	wire   [15:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire   [15:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire   [15:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire   [15:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> otg_hpi_cs_s1_agent:cp_channel
	...
	wire   [28:0] addr_s1_agent_m0_address;                                                           // addr_s1_agent:m0_address -> addr_s1_translator:uav_address
	...
	wire  [107:0] addr_s1_agent_rf_source_data;                                                       // addr_s1_agent:rf_source_data -> addr_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] addr_s1_agent_rsp_fifo_out_data;                                                    // addr_s1_agent_rsp_fifo:out_data -> addr_s1_agent:rf_sink_data
	...
	wire          cmd_mux_012_src_valid;                                                              // cmd_mux_012:src_valid -> addr_s1_agent:cp_valid
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> addr_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // addr_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [15:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> addr_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                                      // cmd_mux_012:src_startofpacket -> addr_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                        // cmd_mux_012:src_endofpacket -> addr_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> data_s1_agent:cp_valid
	wire  [106:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> data_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // data_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [15:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> data_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> data_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> data_s1_agent:cp_endofpacket
	wire   [31:0] hardware_s1_agent_m0_readdata;                                                      // hardware_s1_translator:uav_readdata -> hardware_s1_agent:m0_readdata
	wire          hardware_s1_agent_m0_waitrequest;                                                   // hardware_s1_translator:uav_waitrequest -> hardware_s1_agent:m0_waitrequest
	wire          hardware_s1_agent_m0_debugaccess;                                                   // hardware_s1_agent:m0_debugaccess -> hardware_s1_translator:uav_debugaccess
	wire   [28:0] hardware_s1_agent_m0_address;                                                       // hardware_s1_agent:m0_address -> hardware_s1_translator:uav_address
	wire    [3:0] hardware_s1_agent_m0_byteenable;                                                    // hardware_s1_agent:m0_byteenable -> hardware_s1_translator:uav_byteenable
	wire          hardware_s1_agent_m0_read;                                                          // hardware_s1_agent:m0_read -> hardware_s1_translator:uav_read
	wire          hardware_s1_agent_m0_readdatavalid;                                                 // hardware_s1_translator:uav_readdatavalid -> hardware_s1_agent:m0_readdatavalid
	wire          hardware_s1_agent_m0_lock;                                                          // hardware_s1_agent:m0_lock -> hardware_s1_translator:uav_lock
	wire   [31:0] hardware_s1_agent_m0_writedata;                                                     // hardware_s1_agent:m0_writedata -> hardware_s1_translator:uav_writedata
	wire          hardware_s1_agent_m0_write;                                                         // hardware_s1_agent:m0_write -> hardware_s1_translator:uav_write
	wire    [2:0] hardware_s1_agent_m0_burstcount;                                                    // hardware_s1_agent:m0_burstcount -> hardware_s1_translator:uav_burstcount
	wire          hardware_s1_agent_rf_source_valid;                                                  // hardware_s1_agent:rf_source_valid -> hardware_s1_agent_rsp_fifo:in_valid
	wire  [107:0] hardware_s1_agent_rf_source_data;                                                   // hardware_s1_agent:rf_source_data -> hardware_s1_agent_rsp_fifo:in_data
	wire          hardware_s1_agent_rf_source_ready;                                                  // hardware_s1_agent_rsp_fifo:in_ready -> hardware_s1_agent:rf_source_ready
	wire          hardware_s1_agent_rf_source_startofpacket;                                          // hardware_s1_agent:rf_source_startofpacket -> hardware_s1_agent_rsp_fifo:in_startofpacket
	wire          hardware_s1_agent_rf_source_endofpacket;                                            // hardware_s1_agent:rf_source_endofpacket -> hardware_s1_agent_rsp_fifo:in_endofpacket
	wire          hardware_s1_agent_rsp_fifo_out_valid;                                               // hardware_s1_agent_rsp_fifo:out_valid -> hardware_s1_agent:rf_sink_valid
	wire  [107:0] hardware_s1_agent_rsp_fifo_out_data;                                                // hardware_s1_agent_rsp_fifo:out_data -> hardware_s1_agent:rf_sink_data
	wire          hardware_s1_agent_rsp_fifo_out_ready;                                               // hardware_s1_agent:rf_sink_ready -> hardware_s1_agent_rsp_fifo:out_ready
	wire          hardware_s1_agent_rsp_fifo_out_startofpacket;                                       // hardware_s1_agent_rsp_fifo:out_startofpacket -> hardware_s1_agent:rf_sink_startofpacket
	wire          hardware_s1_agent_rsp_fifo_out_endofpacket;                                         // hardware_s1_agent_rsp_fifo:out_endofpacket -> hardware_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> hardware_s1_agent:cp_valid
	wire  [106:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> hardware_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // hardware_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [15:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> hardware_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> hardware_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> hardware_s1_agent:cp_endofpacket
	wire   [31:0] software_s1_agent_m0_readdata;                                                      // software_s1_translator:uav_readdata -> software_s1_agent:m0_readdata
	wire          software_s1_agent_m0_waitrequest;                                                   // software_s1_translator:uav_waitrequest -> software_s1_agent:m0_waitrequest
	wire          software_s1_agent_m0_debugaccess;                                                   // software_s1_agent:m0_debugaccess -> software_s1_translator:uav_debugaccess
	wire   [28:0] software_s1_agent_m0_address;                                                       // software_s1_agent:m0_address -> software_s1_translator:uav_address
	wire    [3:0] software_s1_agent_m0_byteenable;                                                    // software_s1_agent:m0_byteenable -> software_s1_translator:uav_byteenable
	wire          software_s1_agent_m0_read;                                                          // software_s1_agent:m0_read -> software_s1_translator:uav_read
	wire          software_s1_agent_m0_readdatavalid;                                                 // software_s1_translator:uav_readdatavalid -> software_s1_agent:m0_readdatavalid
	wire          software_s1_agent_m0_lock;                                                          // software_s1_agent:m0_lock -> software_s1_translator:uav_lock
	wire   [31:0] software_s1_agent_m0_writedata;                                                     // software_s1_agent:m0_writedata -> software_s1_translator:uav_writedata
	wire          software_s1_agent_m0_write;                                                         // software_s1_agent:m0_write -> software_s1_translator:uav_write
	wire    [2:0] software_s1_agent_m0_burstcount;                                                    // software_s1_agent:m0_burstcount -> software_s1_translator:uav_burstcount
	wire          software_s1_agent_rf_source_valid;                                                  // software_s1_agent:rf_source_valid -> software_s1_agent_rsp_fifo:in_valid
	wire  [107:0] software_s1_agent_rf_source_data;                                                   // software_s1_agent:rf_source_data -> software_s1_agent_rsp_fifo:in_data
	wire          software_s1_agent_rf_source_ready;                                                  // software_s1_agent_rsp_fifo:in_ready -> software_s1_agent:rf_source_ready
	wire          software_s1_agent_rf_source_startofpacket;                                          // software_s1_agent:rf_source_startofpacket -> software_s1_agent_rsp_fifo:in_startofpacket
	wire          software_s1_agent_rf_source_endofpacket;                                            // software_s1_agent:rf_source_endofpacket -> software_s1_agent_rsp_fifo:in_endofpacket
	wire          software_s1_agent_rsp_fifo_out_valid;                                               // software_s1_agent_rsp_fifo:out_valid -> software_s1_agent:rf_sink_valid
	wire  [107:0] software_s1_agent_rsp_fifo_out_data;                                                // software_s1_agent_rsp_fifo:out_data -> software_s1_agent:rf_sink_data
	wire          software_s1_agent_rsp_fifo_out_ready;                                               // software_s1_agent:rf_sink_ready -> software_s1_agent_rsp_fifo:out_ready
	wire          software_s1_agent_rsp_fifo_out_startofpacket;                                       // software_s1_agent_rsp_fifo:out_startofpacket -> software_s1_agent:rf_sink_startofpacket
	wire          software_s1_agent_rsp_fifo_out_endofpacket;                                         // software_s1_agent_rsp_fifo:out_endofpacket -> software_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> software_s1_agent:cp_valid
	wire  [106:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> software_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // software_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [15:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> software_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> software_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> software_s1_agent:cp_endofpacket
	...
	wire          addr_s1_agent_rp_valid;                                                             // addr_s1_agent:rp_valid -> router_014:sink_valid
	wire  [106:0] addr_s1_agent_rp_data;                                                              // addr_s1_agent:rp_data -> router_014:sink_data
	wire          addr_s1_agent_rp_ready;                                                             // router_014:sink_ready -> addr_s1_agent:rp_ready
	wire          addr_s1_agent_rp_startofpacket;                                                     // addr_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          addr_s1_agent_rp_endofpacket;                                                       // addr_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          data_s1_agent_rp_valid;                                                             // data_s1_agent:rp_valid -> router_015:sink_valid
	wire  [106:0] data_s1_agent_rp_data;                                                              // data_s1_agent:rp_data -> router_015:sink_data
	wire          data_s1_agent_rp_ready;                                                             // router_015:sink_ready -> data_s1_agent:rp_ready
	wire          data_s1_agent_rp_startofpacket;                                                     // data_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          data_s1_agent_rp_endofpacket;                                                       // data_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          hardware_s1_agent_rp_valid;                                                         // hardware_s1_agent:rp_valid -> router_016:sink_valid
	wire  [106:0] hardware_s1_agent_rp_data;                                                          // hardware_s1_agent:rp_data -> router_016:sink_data
	wire          hardware_s1_agent_rp_ready;                                                         // router_016:sink_ready -> hardware_s1_agent:rp_ready
	wire          hardware_s1_agent_rp_startofpacket;                                                 // hardware_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          hardware_s1_agent_rp_endofpacket;                                                   // hardware_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire          software_s1_agent_rp_valid;                                                         // software_s1_agent:rp_valid -> router_017:sink_valid
	wire  [106:0] software_s1_agent_rp_data;                                                          // software_s1_agent:rp_data -> router_017:sink_data
	wire          software_s1_agent_rp_ready;                                                         // router_017:sink_ready -> software_s1_agent:rp_ready
	wire          software_s1_agent_rp_startofpacket;                                                 // software_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          software_s1_agent_rp_endofpacket;                                                   // software_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          addr_s1_agent_rdata_fifo_src_valid;                                                 // addr_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] addr_s1_agent_rdata_fifo_src_data;                                                  // addr_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          addr_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_012:in_0_ready -> addr_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                                  // avalon_st_adapter_012:out_0_valid -> addr_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                                   // avalon_st_adapter_012:out_0_data -> addr_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                                  // addr_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                                  // avalon_st_adapter_012:out_0_error -> addr_s1_agent:rdata_fifo_sink_error
	wire          data_s1_agent_rdata_fifo_src_valid;                                                 // data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] data_s1_agent_rdata_fifo_src_data;                                                  // data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          data_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_013:in_0_ready -> data_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> data_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> data_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // data_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> data_s1_agent:rdata_fifo_sink_error
	wire          hardware_s1_agent_rdata_fifo_src_valid;                                             // hardware_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] hardware_s1_agent_rdata_fifo_src_data;                                              // hardware_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          hardware_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_014:in_0_ready -> hardware_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> hardware_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> hardware_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // hardware_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> hardware_s1_agent:rdata_fifo_sink_error
	wire          software_s1_agent_rdata_fifo_src_valid;                                             // software_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] software_s1_agent_rdata_fifo_src_data;                                              // software_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          software_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_015:in_0_ready -> software_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> software_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> software_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // software_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> software_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) hardware_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_qsys_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (hardware_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (hardware_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (hardware_s1_agent_m0_read),                      //                         .read
		.uav_write              (hardware_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (hardware_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (hardware_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (hardware_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (hardware_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (hardware_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (hardware_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (hardware_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (hardware_s1_address),                            //      avalon_anti_slave_0.address
		.av_write               (hardware_s1_write),                              //                         .write
		.av_readdata            (hardware_s1_readdata),                           //                         .readdata
		.av_writedata           (hardware_s1_writedata),                          //                         .writedata
		.av_chipselect          (hardware_s1_chipselect),                         //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) software_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_qsys_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (software_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (software_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (software_s1_agent_m0_read),                      //                         .read
		.uav_write              (software_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (software_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (software_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (software_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (software_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (software_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (software_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (software_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (software_s1_address),                            //      avalon_anti_slave_0.address
		.av_readdata            (software_s1_readdata),                           //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
		.av_writedata           (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_qsys_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (hardware_s1_agent_m0_address),                   //              m0.address
		.m0_burstcount           (hardware_s1_agent_m0_burstcount),                //                .burstcount
		.m0_byteenable           (hardware_s1_agent_m0_byteenable),                //                .byteenable
		.m0_debugaccess          (hardware_s1_agent_m0_debugaccess),               //                .debugaccess
		.m0_lock                 (hardware_s1_agent_m0_lock),                      //                .lock
		.m0_readdata             (hardware_s1_agent_m0_readdata),                  //                .readdata
		.m0_readdatavalid        (hardware_s1_agent_m0_readdatavalid),             //                .readdatavalid
		.m0_read                 (hardware_s1_agent_m0_read),                      //                .read
		.m0_waitrequest          (hardware_s1_agent_m0_waitrequest),               //                .waitrequest
		.m0_writedata            (hardware_s1_agent_m0_writedata),                 //                .writedata
		.m0_write                (hardware_s1_agent_m0_write),                     //                .write
		.rp_endofpacket          (hardware_s1_agent_rp_endofpacket),               //              rp.endofpacket
		.rp_ready                (hardware_s1_agent_rp_ready),                     //                .ready
		.rp_valid                (hardware_s1_agent_rp_valid),                     //                .valid
		.rp_data                 (hardware_s1_agent_rp_data),                      //                .data
		.rp_startofpacket        (hardware_s1_agent_rp_startofpacket),             //                .startofpacket
		...
		.rf_sink_ready           (hardware_s1_agent_rsp_fifo_out_ready),           //         rf_sink.ready
		.rf_sink_valid           (hardware_s1_agent_rsp_fifo_out_valid),           //                .valid
		.rf_sink_startofpacket   (hardware_s1_agent_rsp_fifo_out_startofpacket),   //                .startofpacket
		.rf_sink_endofpacket     (hardware_s1_agent_rsp_fifo_out_endofpacket),     //                .endofpacket
		.rf_sink_data            (hardware_s1_agent_rsp_fifo_out_data),            //                .data
		.rf_source_ready         (hardware_s1_agent_rf_source_ready),              //       rf_source.ready
		.rf_source_valid         (hardware_s1_agent_rf_source_valid),              //                .valid
		.rf_source_startofpacket (hardware_s1_agent_rf_source_startofpacket),      //                .startofpacket
		.rf_source_endofpacket   (hardware_s1_agent_rf_source_endofpacket),        //                .endofpacket
		.rf_source_data          (hardware_s1_agent_rf_source_data),               //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_014_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_014_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_014_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_014_out_0_error),              //                .error
		.rdata_fifo_src_ready    (hardware_s1_agent_rdata_fifo_src_ready),         //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (hardware_s1_agent_rdata_fifo_src_valid),         //                .valid
		.rdata_fifo_src_data     (hardware_s1_agent_rdata_fifo_src_data),          //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) hardware_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (hardware_s1_agent_rf_source_data),               //        in.data
		.in_valid          (hardware_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (hardware_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (hardware_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (hardware_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (hardware_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (hardware_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (hardware_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (hardware_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (hardware_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_qsys_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (software_s1_agent_m0_address),                   //              m0.address
		.m0_burstcount           (software_s1_agent_m0_burstcount),                //                .burstcount
		.m0_byteenable           (software_s1_agent_m0_byteenable),                //                .byteenable
		.m0_debugaccess          (software_s1_agent_m0_debugaccess),               //                .debugaccess
		.m0_lock                 (software_s1_agent_m0_lock),                      //                .lock
		.m0_readdata             (software_s1_agent_m0_readdata),                  //                .readdata
		.m0_readdatavalid        (software_s1_agent_m0_readdatavalid),             //                .readdatavalid
		.m0_read                 (software_s1_agent_m0_read),                      //                .read
		.m0_waitrequest          (software_s1_agent_m0_waitrequest),               //                .waitrequest
		.m0_writedata            (software_s1_agent_m0_writedata),                 //                .writedata
		.m0_write                (software_s1_agent_m0_write),                     //                .write
		.rp_endofpacket          (software_s1_agent_rp_endofpacket),               //              rp.endofpacket
		.rp_ready                (software_s1_agent_rp_ready),                     //                .ready
		.rp_valid                (software_s1_agent_rp_valid),                     //                .valid
		.rp_data                 (software_s1_agent_rp_data),                      //                .data
		.rp_startofpacket        (software_s1_agent_rp_startofpacket),             //                .startofpacket
		...
		.rf_sink_ready           (software_s1_agent_rsp_fifo_out_ready),           //         rf_sink.ready
		.rf_sink_valid           (software_s1_agent_rsp_fifo_out_valid),           //                .valid
		.rf_sink_startofpacket   (software_s1_agent_rsp_fifo_out_startofpacket),   //                .startofpacket
		.rf_sink_endofpacket     (software_s1_agent_rsp_fifo_out_endofpacket),     //                .endofpacket
		.rf_sink_data            (software_s1_agent_rsp_fifo_out_data),            //                .data
		.rf_source_ready         (software_s1_agent_rf_source_ready),              //       rf_source.ready
		.rf_source_valid         (software_s1_agent_rf_source_valid),              //                .valid
		.rf_source_startofpacket (software_s1_agent_rf_source_startofpacket),      //                .startofpacket
		.rf_source_endofpacket   (software_s1_agent_rf_source_endofpacket),        //                .endofpacket
		.rf_source_data          (software_s1_agent_rf_source_data),               //                .data
		...
		.rdata_fifo_src_ready    (software_s1_agent_rdata_fifo_src_ready),         //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (software_s1_agent_rdata_fifo_src_valid),         //                .valid
		.rdata_fifo_src_data     (software_s1_agent_rdata_fifo_src_data),          //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) software_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (software_s1_agent_rf_source_data),               //        in.data
		.in_valid          (software_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (software_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (software_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (software_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (software_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (software_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (software_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (software_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (software_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	nios_system_mm_interconnect_0_router_002 router_016 (
		.sink_ready         (hardware_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (hardware_s1_agent_rp_valid),                     //          .valid
		.sink_data          (hardware_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (hardware_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (hardware_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_router_002 router_017 (
		.sink_ready         (software_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (software_s1_agent_rp_valid),                     //          .valid
		.sink_data          (software_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (software_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (software_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (hardware_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (hardware_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (hardware_s1_agent_rdata_fifo_src_ready),         //         .ready
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (software_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (software_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (software_s1_agent_rdata_fifo_src_ready),         //         .ready
